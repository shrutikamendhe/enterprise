...
namespace TTSHWeb
{
    public partial class SelectedProjectReport : System.Web.UI.Page
    {
        #region " Page Event "
        ...
        public void ShowCode()
        {
            try
            {
                ...
                //parameters.Add(new ReportParameter("FromMonth", ddlFromMonth.SelectedItem.Text));

                //parameters.Add(new ReportParameter("ToMonth", ddlToMonth.SelectedItem.Text));
